                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{ route('clientepedidos') }}" class="nav-item nav-link active">Meus pedidos</a>
                        </div>
                        ...
                        @foreach ($pedidos as $pedido)
                            <tr class='text-capitalize'>
                                <td class="align-middle"><img src="img/product-1.jpg" alt=""
                                        style="width: 50px;"> {{ $pedido->nome_produto }}</td>

                                <td class="align-middle">{{ $pedido->qtd_comprada }} </td>


                                <td class="align-middle">R$ {{ number_format($pedido->total_comprado, 2, ',', '.') }}
                                </td>

                                <td class="align-middle">{{ date('d-m-Y', strtotime($pedido->data_compra)) }}</td>
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-3 pt-1">
                            ...
                            <h6 class="font-weight-medium">{{ $qtdComprada }} Itens</h6>
                        </div>
                    </div>
                    <div class="card-footer border-secondary bg-transparent">
                        <div class="d-flex justify-content-between mt-2">
                            <h5 class="font-weight-bold">Total gasto</h5>
                            <h5 class="font-weight-bold">R$ {{ number_format($totalComprado, 2, ',', '.') }}</h5>
                        </div>
                    </div>
                </div>
            </div>
